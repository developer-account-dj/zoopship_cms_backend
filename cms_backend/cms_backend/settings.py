...
SECRET_KEY = 'django-insecure-c@kfn8mszo3=o$kdp4$koe-$a9m@t^ndigu!r+(3w9)dkg7raj'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=6),  # 6 hours access token
...
# Base directory (already exists in default settings.py)
